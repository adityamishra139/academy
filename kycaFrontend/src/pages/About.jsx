          ...
          <div className="flex flex-col md:flex-row items-center gap-6">
            ...
            <div>
              ...
              <p className="text-lg text-gray-300">
                Dr. Arjun Rao is the visionary behind Karnataka Youth Cricket
                Academy. With a deep passion for cricket and years of experience
                in sports management, he started this academy to nurture young
                talent and make a lasting impact on cricket in the region.
              </p>
              <p className="mt-2 text-sm text-gray-400">
                His vision is to provide a comprehensive environment that
                focuses not only on physical training but also on the mental
                well-being and overall development of young cricketers.
              </p>
            </div>
          </div>
        </div>
              ...
              coaches.map((coach, index) => (
                <div className="flex items-center gap-6" key={index}>
                  <img
                    ...
                    alt={`Coach ${index + 1}`}
                    className="w-40 h-40 rounded-full shadow-lg transition-transform transform hover:scale-105 object-cover"
                  />
